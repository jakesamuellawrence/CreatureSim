...
public class CSStatblock extends JPanel{
	...
	public void paintComponent(Graphics g){
		...
		g.drawString("Highest Survival Time: " + high_survival_time, getWidth()/2, getHeight()*2/7);
		g.drawString("Average Survival Time: " + av_survival_time, getWidth()/2, getHeight()*4/7);
